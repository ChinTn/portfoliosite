      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16 mx-auto max-w-fit">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left max-w-xl md:pl-8 lg:pl-12 w-full">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-text-main to-text-dim mb-2 tracking-tight">
              ChinTn
            </h1>
            ...
            {/* Info Card (Bio & Widget) */}
            <div className="w-full flex flex-col md:flex-row items-center md:items-center justify-between bg-card-bg/40 backdrop-blur-md border border-border-dim/50 p-5 rounded-2xl mb-8 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
              <div className="text-center md:text-left mb-5 md:mb-0">
                <div className="text-text-main font-bold text-lg mb-1">
            ...
            {/* Text Description */}
            <div className="text-text-dim/90 text-[15px] md:text-base leading-relaxed mb-8 max-w-lg font-light">
              <p className="mb-4">
            ...
            <div className="flex items-center justify-center md:justify-start gap-5 text-xl md:text-2xl text-text-dim">
              <a href="https://www.linkedin.com/in/chintan-vaghamshi-6578262aa/" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-card-bg-light/50 border border-border-dim/30 hover:text-highlight hover:border-highlight hover:bg-highlight/10 transition-all duration-300"><i className="fab fa-linkedin"></i></a>
              <a href="https://github.com/ChinTn" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-card-bg-light/50 border border-border-dim/30 hover:text-highlight hover:border-highlight hover:bg-highlight/10 transition-all duration-300"><i className="fab fa-github"></i></a>
              <a href="https://www.instagram.com/chintan_v_011/" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-card-bg-light/50 border border-border-dim/30 hover:text-highlight hover:border-highlight hover:bg-highlight/10 transition-all duration-300"><i className="fab fa-instagram"></i></a>
              <a href="https://x.com/ChinTn_011" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-card-bg-light/50 border border-border-dim/30 hover:text-highlight hover:border-highlight hover:bg-highlight/10 transition-all duration-300"><i className="fab fa-twitter"></i></a>
              <a href="https://discord.com/users/769396189572628500" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-card-bg-light/50 border border-border-dim/30 hover:text-highlight hover:border-highlight hover:bg-highlight/10 transition-all duration-300"><i className="fab fa-discord"></i></a>
            </div>
          </div>
